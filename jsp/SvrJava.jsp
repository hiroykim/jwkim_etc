...
<%
	...
	String getParam = request.getParameter("testParam");
	out.println("<br>getParam -> " + request.getParameter("testParam"));
	out.println("<br>postParam -> " + request.getParameter("postParam"));
	...
	try{
		...
		map.put("strRemoteFileName","moved/3/3/ga_test_3.wav");
